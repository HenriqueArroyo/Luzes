...
<body>  
    ...
    $sql_patrimonio = "SELECT codigo, item, status FROM Patrimonio WHERE ID_sala = 3";
    ...
    $sql_estoque = "SELECT item, quantidade FROM Estoque WHERE ID_sala = 3";
    $estoque_stmt = $pdo->query($sql_estoque);
    $estoques = $estoque_stmt->fetchAll(PDO::FETCH_ASSOC);
    ?>

<h1> Bem vindo a SALA 03</h1>
